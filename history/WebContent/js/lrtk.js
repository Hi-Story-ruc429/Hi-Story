...
if (code=="egg"){// egg
document.write('* 牛图库承诺：本站所有资源免费下载，无病毒，无弹窗，无干扰链接！ <a href="/plus/guestbook.php">全新改版 提点建议</a>');}
if (code=="jinbu"){// 进步
...
//document.writeln ('<dd>06月01日 牛图库2012新版上线</dd>');
...
switch(all_var)
{case"png": document.formsearch.action='http://www.niutuku.com/manager/plus/png.php?type=search&q='+q
break;case"js":document.formsearch.action='http://www.niutuku.com/manager/plus/js.php?q='+q
break;
default:
        var Sys = {};
...
document.formsearch.action='http://www.niutuku.com/plus/search.php?x='+all_var+'&q='+q;break;}
document.formsearch.submit();return false;
}

// fav
function addToFavorite(){var a="http://www.niutuku.com/";var b="牛图库";if(document.all){window.external.AddFavorite(a,b)}else if(window.sidebar){window.sidebar.addPanel(b,a,"")}else{alert("亲，您的浏览器不支持此操作\n请直接使用Ctrl+D收藏本站~")}}
// thumb
$(function() {
